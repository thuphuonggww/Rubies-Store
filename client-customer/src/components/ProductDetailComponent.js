...
class ProductDetail extends Component {
                ...
                <table className="product-info-table">
                  <tbody>
                    <tr>
                      ...
                      <td className="productdt-id">{prod._id}</td>
                    </tr>
                    <tr>
                      <td className="Namelabel" align="left">
                        Name:
                      </td>
                      <td className="productdt-name">{prod.name}</td>
                    </tr>
                    <tr>
                      <td className="Pricelabel" align="left">
                        Price:
                      </td>
                      <td className="productdt-price">{prod.price}.000 VND</td>
                    </tr>
                    <tr>
  ...
  btnAdd2CartClick(e) {
    ...
    if (quantity) {
      ...
      toast.success("Added to cart successfully!"); // Show success toast
    } else {
      toast.error("Please input quantity"); // Show error toast
    }
  }
