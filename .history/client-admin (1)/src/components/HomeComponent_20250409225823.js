...
class Home extends Component {
  ...
  fetchStats() {
    ...
    axios.get('/api/admin/customers', config).then((res) => {
      this.setState({ customers: res.data.length || 28 });
    }).catch(() => this.setState({ customers: 28 }));
  }
  
  renderSkeletonCard() {
    return (
      <div className="dashboard-card loading-skeleton" style={{height: '150px'}}>
        <div style={{height: '20px', width: '40%', marginBottom: '15px'}}></div>
        <div style={{height: '40px', width: '30%', marginBottom: '10px'}}></div>
      ...
      <div className="data-table-container">
        ...
        <div className="recent-activities">
          ...
          <ul className="activity-list">
            ...
            <li className="activity-item">
              <div className="activity-icon"><i className="fas fa-shopping-bag"></i></div>
              <div className="activity-content">
            ...
            <li className="activity-item">
              ...
              <div className="activity-content">
                <div className="activity-title">New comment on iPhone 13 product</div>
