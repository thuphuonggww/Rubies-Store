  ...
  return (
    <footer className="footer-enhanced">
      <div className="footer-container">
        ...
        <div className="footer-section">
          <h4>Follow Us</h4>
          <a href="https://www.facebook.com/rubiesin2015/" target="_blank">
        <img src="https://cdn-icons-png.flaticon.com/128/3670/3670124.png" alt="Facebook" width="40">
      </a>
      <a href="https://www.instagram.com/rubies.sg/" target="_blank">
        <img src="https://cdn-icons-png.flaticon.com/128/3955/3955024.png" alt="Instagram" width="40">
      </a>
      <a href="https://www.youtube.com/channel/UCALOExnNJaJG9YS9lvTnhsg" target="_blank">
