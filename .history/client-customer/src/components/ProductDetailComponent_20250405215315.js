    ...
    if (prod != null) {
      return (
        <div className="product-detail-container align-center">
          ...
          <figure className="product-image-container captleft">
            <img
            ...
            <figcaption className="product-info-container">
              <form className="product-info-form">
                <table className="product-info-table">
                  <tbody>
                    <tr>
                      <td className="IDlabel" alileft">
                        ID:
                      </td>
                      <td className="product-id">{prod._id}</td>
                    </tr>
                    <tr>
                      <td className="Namelabel" alileft">
                        Name:
                      </td>
                      <td className="product-name">{prod.name}</td>
                    </tr>
                    <tr>
                      <td className="Pricelabel" alileft">
                        Price:
                      </td>
                      <td className="productdt-price">{prod.price}</td>
                    </tr>
                    <tr>
                      <td className="Categorylabel" alileft">
                        Category:
                      </td>
