            ...
            <figcaption className="product-info-container">
              <form className="product-info-form">
                <table className="product-info-table">
                  <tbody>
                    <tr>
                      <td className="IDlabel" align="right">
                        ID:
                      </td>
                      <td className="product-id">{prod._id}</td>
                    </tr>
                    <tr>
                      <td className="Namelabel" align="right">
                        Name:
                      </td>
                      <td className="product-name">{prod.name}</td>
                    </tr>
                    <tr>
                      <td className="Pricelabel" align="right">
                        Price:
                      </td>
                      <td className="productdt-price">{prod.price}</td>
                    </tr>
                    <tr>
                      <td className="Categorylabel" align="right">
                        Category:
                      </td>
                      <td className="product-category">{prod.category.name}</td>
                    </tr>
                    <tr>
                      <td className="Quantitylabel" align="right">
                        Quantity:
                      </td>
                      <td>
                        <input
